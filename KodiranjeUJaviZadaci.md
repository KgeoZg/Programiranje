...
<p align="justify">Sastaviti dijagram toka i pseudokôd za pretvaranje vrijednosti kuta iz seksagezimalne mjere u lučnu mjeru i obrnuto, tj. iz lučne u seksagezimalnu mjeru. Pretpostavka je da se radi o pozitivnoj vrijednosti kuta.<br>
<div class="btn-acc-group">
  <!-- Change to checkbox and remove 'name' -->
